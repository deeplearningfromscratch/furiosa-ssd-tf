...
NAME_REMAP['/conv_1/'] = '/Conv/'
NAME_REMAP['/conv_2/'] = '/Conv_1/'
NAME_REMAP['/expanded_conv_1/'] = '/expanded_conv/'
for ind in range(1, 17):
    NAME_REMAP['/expanded_conv_{}/'.format(ind+1)] = '/expanded_conv_{}/'.format(ind)
